 ...
 */
final class Version20190414015056 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE appointment (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, customer_id INT DEFAULT NULL, place_id INT DEFAULT NULL, date DATETIME NOT NULL, UNIQUE INDEX UNIQ_FE38F844A76ED395 (user_id), UNIQUE INDEX UNIQ_FE38F8449395C3F3 (customer_id), UNIQUE INDEX UNIQ_FE38F844DA6A219 (place_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
