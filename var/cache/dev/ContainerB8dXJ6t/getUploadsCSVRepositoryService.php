...
// Returns the private 'App\Repository\UploadsCSVRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\UploadsCSVRepository.php';

return $this->privates['App\Repository\UploadsCSVRepository'] = new \App\Repository\UploadsCSVRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
